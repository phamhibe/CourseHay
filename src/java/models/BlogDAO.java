...
public class BlogDAO extends DBContext {
    ...
    public ArrayList<Category> getBlogCategoryListBySql(String sql) {
        ArrayList<Category> BlogCategoryList = new ArrayList<Category>();
        try {
            ...
            while (rs.next()) {
                ...
                Category b = new Category(CategoryID, CategoryName);
